...
main:
	...
	mov	r2, #1
	mov	r3, r2
	str	ip, [r7, #4]	@  bg_day,  <variable>.ti
	mov	r1, #320
	ldr	r0, .L5+28
	mov	lr, pc
	bx	r4
	mov	r3, r0	@  bg_day
	ldr	r5, .L5+32
	str	r3, [r7, #24]	@  bg_day,  <variable>.ti
	mov	r1, #0
	mov	r0, #3
	mov	lr, pc
	bx	r5
	mov	r3, r0	@  bg_day
	str	r3, [r7, #0]	@  bg_day,  <variable>.mi
	mov	r1, #0
	mov	r0, #3
	mov	lr, pc
	bx	r5
	...
	mov	r5, #30	@  bg_day
	mov	r6, #20	@  bg_day
	str	ip, [r7, #20]	@  bg_day,  <variable>.mi
	mov	r1, r5	@  bg_day
	ldr	r8, .L5+36
	mov	r2, r6	@  bg_day
	mov	r3, r4	@  bg_day
	ldr	r0, .L5+40
	stmia	sp, {r4, r5, r6}	@ phole stm
	str	r4, [sp, #12]	@  bg_day
	mov	lr, pc
	bx	r8
	mov	r1, r5	@  bg_day
...
pipesGenerator:
	...
	sub	sp, sp, #36
	ldr	sl, .L37
	ldr	r6, .L37+4	@  initial_y_pipe_position
	mov	r1, #10
	ldr	r3, .L37+8
	mov	r0, #0
	mov	r4, #0
	mov	lr, pc
	bx	r3
	ldrh	ip, [sl, #0]	@  rand_pipe_x
	ldr	r9, .L37+12
	mov	r8, #1
	mov	r1, #2
	mov	r2, #3
	mov	r3, r4
	mov	r0, r6	@  initial_y_pipe_position
	str	ip, [sp, #28]
	str	r8, [sp, #0]
	str	r4, [sp, #4]
	str	r4, [sp, #8]
	...
	bx	r9
	ldr	ip, .L37+16
	mov	r5, r0	@  initial_y_pipe_position
	ldrh	lr, [sl, #4]	@  rand_pipe_x
	strb	r5, [ip, #0]	@  initial_y_pipe_position,  pipeDownSpt0
	mov	r1, #2
	mov	r2, #3
	mov	r3, r4
	mov	r0, r6	@  initial_y_pipe_position
	...
	ldr	ip, .L37+20
	mov	r5, r0	@  initial_y_pipe_position
	ldrh	lr, [sl, #8]	@  rand_pipe_x
	strb	r5, [ip, #0]	@  initial_y_pipe_position,  pipeDownSpt1
	mov	r0, r6	@  initial_y_pipe_position
	mov	r1, #2
	mov	r2, #3
	mov	r3, r4
	...
	mov	lr, pc
	bx	r9
	ldr	r7, .L37+24	@  initial_y_pipe_position
	ldr	ip, .L37+28
	mov	r5, r0	@  initial_y_pipe_position
	ldrh	lr, [sl, #0]	@  rand_pipe_x
	strb	r5, [ip, #0]	@  initial_y_pipe_position,  pipeDownSpt2
	mov	r6, #96
	mov	r1, #2
	mov	r2, #3
	mov	r3, r4
	mov	r0, r7	@  initial_y_pipe_position
	str	lr, [sp, #28]
	str	r8, [sp, #0]
	str	r4, [sp, #4]
	str	r4, [sp, #8]
	...
	mov	r5, r0	@  initial_y_pipe_position
	ldrh	lr, [sl, #4]	@  rand_pipe_x
	strb	r5, [ip, #0]	@  initial_y_pipe_position,  pipeUpSpt0
	mov	r1, #2
	mov	r2, #3
	mov	r3, r4
	mov	r0, r7	@  initial_y_pipe_position
	...
	mov	r5, r0	@  initial_y_pipe_position
	ldrh	lr, [sl, #8]	@  rand_pipe_x
	strb	r5, [ip, #0]	@  initial_y_pipe_position,  pipeUpSpt1
	mov	r3, r4
	mov	r0, r7	@  initial_y_pipe_position
	mov	r1, #2
	mov	r2, #3
	...
	bx	r9
	ldr	r3, .L37+40
	strb	r0, [r3, #0]	@  initial_y_pipe_position,  pipeUpSpt2
