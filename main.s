...
setBackGrounds:
	...
	mov	r3, r0
	ldr	r4, .L28+28
	str	r3, [r7, #24]	@  <variable>.ti
	mov	r1, #0
	mov	r0, #3
	mov	lr, pc
	bx	r4
	mov	r3, r0
	str	r3, [r7, #0]	@  <variable>.mi
	mov	r1, #0
	mov	r0, #3
	mov	lr, pc
	bx	r4
...
moveGround:
	...
	ldr	r1, .L31
	ldr	r3, [r1, #0]	@  ground_x
	add	r3, r3, #1
	str	r3, [r1, #0]	@  ground_x
	ldr	r3, .L31+4
	sub	fp, ip, #4
	ldrb	r2, [r1, #0]	@ zero_extendqisi2	@  ground_x
	ldr	r0, [r3, #0]	@  bg_ground
	mov	r1, #1
	mov	r3, #0
	ldr	ip, .L31+8
	mov	lr, pc
